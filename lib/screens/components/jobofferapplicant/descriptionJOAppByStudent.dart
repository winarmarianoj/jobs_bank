    ...
    return Padding(
      ...
      child: Column(        
        ...
        children: <Widget>[
          ...
          ItemCardTextWidget(label: "Applied: ", text: joApp.applied, fontWeight: FontWeight.bold, /* color: descriptionJobOfferDetails */ size: 14,),
          const SizedBox(height: defaultSpaceBetweenObjectsDescription),
          ItemCardTextWidget(label: "DeletedDay: ", text: joApp.deletedDay, fontWeight: FontWeight.normal, /* color: themeProductJobOfferPublisherTextTitle, */ size: 14,),
          const SizedBox(height: defaultSpaceBetweenObjectsDescription),
          ...
          const SizedBox(height: defaultSpaceBetweenObjectsDescription),
          ItemCardTextWidget(label: "Title: ", text: joApp.title, fontWeight: FontWeight.normal, /* color: themeProductJobOfferPublisherTextTitle, */ size: 14,),
          const SizedBox(height: defaultSpaceBetweenObjectsDescription),
          ItemCardTextWidget(label: "Description: ", text: joApp.description, fontWeight: FontWeight.normal, /* color: themeProductJobOfferPublisherTextTitle, */ size: 14,),
          const SizedBox(height: defaultSpaceBetweenObjectsDescription),
