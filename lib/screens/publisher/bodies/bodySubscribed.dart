...
class BodySubscribed extends StatelessWidget{
  ...
  const BodySubscribed({Key? key, required this.user, required this.jobOffer}) : super(key: key);  
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        FutureBuilder(                  
          future: reportService.getAllAppliedByJobOffer(jobOffer.id, context),
          builder: (context, snapshot) {
            if(snapshot.hasData){
              ...
              return Text(logJobOfferAppFailedBodySubscribed);
            }
